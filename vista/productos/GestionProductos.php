    ...
    <main class="contenido-gestion">
        <div class="container-tabla">
            <div class="header-seccion">
                ...
                <a href="index.php?action=AnadirProducto" class="btn-anadir">
                    <i class="fas fas fa-tshirt"></i> Nuevo Producto
                </a>
            </div>
            ...
            <table class="tabla-gestion">
                ...
                <tbody>
                    <?php if (!empty($productosPag)): ?>
                        <?php foreach ($productosPag as $p): ?>
                            <tr>
                                <td><?= $p['ID_PRODUCTO'] ?></td>
                                ...
                                <td>
                                    <a href="index.php?action=EditarProducto&id=<?= $p['ID_PRODUCTO'] ?>" class="btn-icon edit"><i class="fas fa-edit"></i></a>
                                    <a href="index.php?action=EliminarStock&id_producto=<?= $p['ID_PRODUCTO'] ?>&id_talla=<?= $p['ID_TALLA'] ?>" 
                                    class="btn-icon delete" onclick="return confirm('¿Eliminar el stock de la talla <?= $p['TALLA'] ?> para este producto?')">
